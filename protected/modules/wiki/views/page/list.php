        ...
        <div class="row">
            <div class="col-lg-10 col-md-9 col-sm-9 wiki-content">
                ...
                <?php if (count($pages) != 0) : ?>
                    <h1><?php echo Yii::t('WikiModule.base', '<strong>Overview</strong> of all articles'); ?></h1>
                <?php endif; ?>

                <?php if (count($pages) == 0) : ?>
                    <div class="text-center wiki-welcome">
                        <h1><?php echo Yii::t('WikiModule.base', 'Articles'); ?></h1>
                ...
                <ul class="wiki-list">
                    <?php foreach ($pages as $page): ?>
                        ...
                        <li>
                            <h1 class="wiki-page-history-title"><?php echo HHtml::link('<i class="fa fa-file-text-o"></i> ' . CHtml::encode($page->title), $this->createContainerUrl('view', array('title' => $page->title)). Yii::t('WikiModule.base', "Autor: ")
                            . User::model()->findByPk($page->content->created_by)->username
                            . " "
                            . Yii::t('WikiModule.base', "Utworzono: ")
                            . $page->content->created_at); ?></h1>
                            <?php
                            echo Yii::t('WikiModule.base', "Autor: "); 
                            echo User::model()->findByPk($page->content->created_by)->username;
                            echo " ";
                            echo Yii::t('WikiModule.base', "Utworzono: ");
                            echo $page->content->created_at;
                            ?>
                        </li>
                    <?php endforeach; ?>
                </ul>
